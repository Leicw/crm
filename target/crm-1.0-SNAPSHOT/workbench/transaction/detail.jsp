...
<%@ page import="com.lcw.crm.settings.domain.DicValue" %>
<%@ page import="com.lcw.crm.workbench.domain.Tran" %>
...
//                    丢失后的阶段，这里需要判断一次当前阶段是否为遍历的阶段，如果是当前阶段，则红叉，不是黑叉
...
//这里表示当前阶段不是丢失阶段
//                    颜色标记，true表示绿圈，false表示黑圈,遇到当前阶段会赋值为false
            Boolean color = true;
//            遍历一次循环
            for (int i = 0;i<stageList.size();i++){
                //                准备好当前阶段的值
